...
public final class Metadata {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (sr_ != 0) {
        output.writeInt32(3, sr_);
      }
      if (tg_ != 0) {
        output.writeInt32(4, tg_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (sr_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeInt32Size(3, sr_);
      }
      if (tg_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeInt32Size(4, tg_);
      }
      for (int i = 0; i < dsItem_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getTg()
          != other.getTg()) return false;
      if (!getDsItemList()
          .equals(other.getDsItemList())) return false;
      if (!unknownFields.equals(other.unknownFields)) return false;
      return true;
    }
  ...
  public interface GetMessageOrBuilder extends
    ...
    /**
     * <code>repeated .Metadata.TgTimeItem ds_item = 2;</code>
     */
    java.util.List<edu.msu.cse.dkvf.metadata.Metadata.TgTimeItem> 
        getDsItemList();
    /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int DS_ITEM_FIELD_NUMBER = 2;
    private java.util.List<edu.msu.cse.dkvf.metadata.Metadata.TgTimeItem> dsItem_;
    /**
     * <code>repeated .Metadata.TgTimeItem ds_item = 2;</code>
     */
    ...
    public static final int CG_FIELD_NUMBER = 3;
    private int cg_;
    /**
     * <code>int32 cg = 3;</code>
     */
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < dsItem_.size(); i++) {
        output.writeMessage(2, dsItem_.get(i));
      }
      if (cg_ != 0) {
        output.writeInt32(3, cg_);
      }
      unknownFields.writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < dsItem_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(2, dsItem_.get(i));
      }
      if (cg_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeInt32Size(3, cg_);
      }
      size += unknownFields.getSerializedSize();
      memoizedSize = size;
      return size;
  ...
  public interface VVMessageOrBuilder extends
    ...
    /**
     * <code>repeated int64 vvItem = 2;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int VVITEM_FIELD_NUMBER = 2;
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 8: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                svvItem_ = newLongList();
                mutable_bitField0_ |= 0x00000001;
              }
              svvItem_.addLong(input.readInt64());
              break;
            }
            case 10: {
              int length = input.readRawVarint32();
    ...
    private com.google.protobuf.Internal.LongList svvItem_;
    /**
     * <code>repeated int64 svvItem = 1;</code>
     */
    public java.util.List<java.lang.Long>
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < svvItem_.size(); i++) {
        output.writeInt64NoTag(svvItem_.getLong(i));
      }
      unknownFields.writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      {
        ...
        for (int i = 0; i < svvItem_.size(); i++) {
          dataSize += com.google.protobuf.CodedOutputStream
            .computeInt64SizeNoTag(svvItem_.getLong(i));
        }
        size += dataSize;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!getSvvItemList()
          .equals(other.getSvvItemList())) return false;
      if (!unknownFields.equals(other.unknownFields)) return false;
      return true;
    }
    ...
    public static final class Builder extends
      ...
      private com.google.protobuf.Internal.LongList svvItem_ = emptyLongList();
      private void ensureSvvItemIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          svvItem_ = mutableCopy(svvItem_);
      ...
      public java.util.List<java.lang.Long>
        ...
        return ((bitField0_ & 0x00000001) != 0) ?
                 java.util.Collections.unmodifiableList(svvItem_) : svvItem_;
      }
      /**
       * <code>repeated int64 svvItem = 1;</code>
       */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      switch (messageTypeCase_) {
        ...
        case 4:
          if (!getSvvMessage()
              .equals(other.getSvvMessage())) return false;
          break;
        case 0:
        default:
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\013eaccf.proto\022\010Metadata\"&\n\nTgTimeItem\022\n\n" +
      "\002tg\030\001 \001(\005\022\014\n\004time\030\002 \001(\003\"b\n\006Record\022\r\n\005val" +
      "ue\030\001 \001(\014\022\n\n\002ut\030\002 \001(\003\022\n\n\002sr\030\003 \001(\005\022\n\n\002tg\030\004" +
      " \001(\005\022%\n\007ds_item\030\005 \003(\0132\024.Metadata.TgTimeI" +
      "tem\"L\n\nGetMessage\022\013\n\003key\030\001 \001(\t\022%\n\007ds_ite" +
      "m\030\002 \003(\0132\024.Metadata.TgTimeItem\022\n\n\002cg\030\003 \001(" +
      "\005\"O\n\nPutMessage\022\013\n\003key\030\001 \001(\t\022\r\n\005value\030\002 " +
      "\001(\014\022%\n\007ds_item\030\003 \003(\0132\024.Metadata.TgTimeIt" +
      "em\"y\n\rClientMessage\022+\n\013get_message\030\001 \001(\013" +
      "2\024.Metadata.GetMessageH\000\022+\n\013put_message\030" +
      "\002 \001(\0132\024.Metadata.PutMessageH\000B\016\n\014message" +
      "_type\"\'\n\010GetReply\022\033\n\001D\030\001 \001(\0132\020.Metadata." +
      "Record\".\n\010PutReply\022\n\n\002ut\030\001 \001(\003\022\n\n\002sr\030\002 \001" +
      "(\005\022\n\n\002tg\030\003 \001(\005\"\177\n\013ClientReply\022\016\n\006status\030" +
      "\001 \001(\010\022\'\n\tget_reply\030\002 \001(\0132\022.Metadata.GetR" +
      "eplyH\000\022\'\n\tput_reply\030\003 \001(\0132\022.Metadata.Put" +
      "ReplyH\000B\016\n\014message_type\"H\n\020ReplicateMess" +
      "age\022\013\n\003key\030\001 \001(\t\022\033\n\001D\030\002 \001(\0132\020.Metadata.R" +
      "ecord\022\n\n\002tg\030\003 \001(\005\",\n\020HeartbeatMessage\022\014\n" +
      "\004time\030\001 \001(\003\022\n\n\002tg\030\002 \001(\005\".\n\tVVMessage\022\021\n\t" +
      "server_id\030\001 \001(\t\022\016\n\006vvItem\030\002 \003(\003\"\035\n\nSVVMe" +
      "ssage\022\017\n\007svvItem\030\001 \003(\003\"\351\001\n\rServerMessage" +
      "\0227\n\021replicate_message\030\001 \001(\0132\032.Metadata.R" +
      "eplicateMessageH\000\0227\n\021heartbeat_message\030\002" +
      " \001(\0132\032.Metadata.HeartbeatMessageH\000\022)\n\nvv" +
      "_message\030\003 \001(\0132\023.Metadata.VVMessageH\000\022+\n" +
      "\013svv_message\030\004 \001(\0132\024.Metadata.SVVMessage" +
      "H\000B\016\n\014message_typeB%\n\031edu.msu.cse.dkvf.m" +
      "etadataB\010Metadatab\006proto3"
    };
    ...
    internal_static_Metadata_Record_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_Metadata_Record_descriptor,
        new java.lang.String[] { "Value", "Ut", "Sr", "Tg", "DsItem", });
    internal_static_Metadata_GetMessage_descriptor =
      getDescriptor().getMessageTypes().get(2);
    internal_static_Metadata_GetMessage_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_Metadata_GetMessage_descriptor,
        new java.lang.String[] { "Key", "DsItem", "Cg", });
    internal_static_Metadata_PutMessage_descriptor =
    ...
    internal_static_Metadata_VVMessage_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_Metadata_VVMessage_descriptor,
        new java.lang.String[] { "ServerId", "VvItem", });
    internal_static_Metadata_SVVMessage_descriptor =
