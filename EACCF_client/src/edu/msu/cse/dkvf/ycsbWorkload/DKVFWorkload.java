package edu.msu.cse.dkvf.ycsbWorkload;

/**
 * Modified CoreWorkload generator of YCSB for DKVF. 
 * 
 ...
 * </ul>
 */
public class DKVFWorkload extends Workload {
  /**
  ...
  //DKVF
  public static final String ROTX_PROPORTION_PROPERTY  = "rotxproportion"; 
  public static final String AMP_INSERT_PROPORTION_PROPERTY = "ampinsertproportion";
  public static final String AMP_FACTOR = "ampfactor";
  public static final String ROTX_KEY_NUMBER = "rotxkeynumber";
  /**
   * The default proportion of transactions that are inserts.
   */
  public static final String INSERT_PROPORTION_PROPERTY_DEFAULT = "0.0";

  public static final String ROTX_PROPORTION_PROPERTY_DEFAULT   = "0.0"; 
  public static final String AMP_INSERT_PROPORTION_PROPERTY_DEFAULT  = "0.0";
  public static final String AMP_FACTOR_DEFAULT = "100";
  public static final String ROTX_KEY_NUMBER_DEFAULT = "10";
  /**
  ...
  protected int ampFactor;
  protected int rotxKeyNumber; 
  ...
  public void init(Properties p) throws WorkloadException {
    ...
    fieldlengthgenerator = DKVFWorkload.getFieldLengthGenerator(p);
    ...
    ampFactor = Integer.parseInt(p.getProperty(AMP_FACTOR, AMP_FACTOR_DEFAULT));
    rotxKeyNumber = Integer.parseInt(p.getProperty(ROTX_KEY_NUMBER, ROTX_KEY_NUMBER_DEFAULT));
    long insertstart =
  ...
  //DKVF 
  private ByteIterator buildSingleValueData (){
...
*/
  ...
  public boolean doInsert(DB db, Object threadstate) {
	    ...
	    int keynum = keysequence.nextValue().intValue();
	    String dbkey = buildKeyName(keynum);
	    ByteIterator value = buildSingleValueData();
  ...
  public boolean doTransaction(DB db, Object threadstate) {
    ...
    //DKVF
    case "ROTX":
        doTransactionROTX(db);
        break;
    case "AMP_INSERT":
        doTransactionAmpInsert(db);
        break;
    /* 
    case "SCAN":
...
/*
  ...
  */
  ...
  //DKVF doTransactionRead
  public void doTransactionRead(DB db) {
    // choose a random key
    long keynum = nextKeynum();

    String keyname = buildKeyName(keynum);    
    Set<ByteIterator> value = new HashSet<>();
    

	long ist = measurements.getIntendedtartTimeNs();
	long st = System.nanoTime();
    db.read(keyname, value);
...
/*
  ...
  //DKVF doTransactionROTX
	public void doTransactionROTX(DB db) {
		
	    Set<String> keys = new HashSet<>();
	    for (int i = 0; i < rotxKeyNumber; i++){
	    	long keynum = nextKeynum();
		    String keyname = buildKeyName(keynum);
		    keys.add(keyname);
	    }
		...
		long ist = measurements.getIntendedtartTimeNs();
		long st = System.nanoTime();
	    db.rotx(keys, results);
	    long en = System.nanoTime();

		measurements.measure("ROTX", (int) ((en - st) / 1000));
		measurements.measureIntended("ROTX", (int) ((en - ist) / 1000));
	}
	
  //DKVF doTransactionAmpInsert
	public void doTransactionAmpInsert(DB db) {
		...
		measurements.measure("AMP_INSERT", (int) ((en - st) / 1000));
		measurements.measureIntended("AMP_INSERT", (int) ((en - ist) / 1000));
	}
  ...
  protected static DiscreteGenerator createOperationGenerator(final Properties p) {
    ...
    //DKVF
    final double rotxproportion = Double.parseDouble(
            p.getProperty(ROTX_PROPORTION_PROPERTY, ROTX_PROPORTION_PROPERTY_DEFAULT));
    
    final double ampinsertproportion = Double.parseDouble(
            p.getProperty(AMP_INSERT_PROPORTION_PROPERTY, AMP_INSERT_PROPORTION_PROPERTY_DEFAULT));
    ...
    //DKVF
    if (rotxproportion > 0) {
        operationchooser.addValue(rotxproportion, "ROTX");
      }
    
    if (ampinsertproportion > 0) {
        operationchooser.addValue(ampinsertproportion, "AMP_INSERT");
      }
